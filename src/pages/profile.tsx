  ...
  return (
    <div>
      ...
      <Grid item xs={12} style={{ display: 'flex', justifyContent: 'center', marginTop: '20px' }}>
        <FormControlLabel
          control={<Checkbox color="secondary" name="saveAddress" value="yes" checked={isCheckboxChecked} onChange={handleCheckboxChange} />}
      ...
      <Container sx={{ py: 8 }} maxWidth="md">
          ...
          {visibleCards.map((card, index) => (
            <Card
              ...
              style={{
                ...
                transform: `translateX(${(index - currentIndex % couponsPerPage) * 100}%)`, // 슬라이드 애니메이션
        ...
        {cards.length > couponsPerPage && (
          <div style={{ marginTop: '16px' }}>
            ...
            {Array.from({ length: Math.ceil(cards.length / couponsPerPage) }, (_, index) => (
              <Button
                key={index}
        ...
        <Grid container>
            <AppBar position="relative">
              <Toolbar>
                ...
                >
                <Button color="info" variant="contained" onClick={handleEditClick}>Edit</Button>
                <Button color="info" variant="contained" onClick={handleCheckCouponsClick}>Check Coupons</Button>
                <Button color="warning" variant="contained">wrote</Button>
                <Button color="success" variant="contained">Crazy</Button>
                <div style={{ flex: 1}} />
              </Stack>
            </Toolbar>
          </AppBar>
